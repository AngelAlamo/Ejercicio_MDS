...
ggscatter(vh_mds_phylum, x = "Dim.1", y = "Dim.2", size = 1, color = "V2",
          palette = c("deeppink", "orange", "yellow", "green", "cyan", "blue", "purple", "violetred", "tan4", "orangered", "olivedrab", "black", "cornsilk3", "red4")
          )
