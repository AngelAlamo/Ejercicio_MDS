...
Ahora, fijandonos en la coloración según el nivel phylum, la primera agrupación es de individuos vertebrados, y la tercera de individuos artropodos. Sin embargo, la segunda agrupación contiene todos los grupos phylum. También, volvemos a observar una tendencia de los vertebrados (rosas) hacia la izquierda y de los artrópodos (azules) hacia la izquierda.
...
```
En este gráfico, vemos dos agrupaciones claras: una en la parte negativa de la primera coordenada principal y otra en la parte positiva. Podemos observar que, como en el primer gráfico, volvemos a tener una separación clara de los individuos vertebrados. Sin embargo, en la agrupación de la derecha, tenemos al resto de individuos, aunque el grupo de artrópodos tiene una tendencia al alza respecto a la segunda coordenada.
